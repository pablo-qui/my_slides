...
<li class='fragment fade-in'> SystolicBP: systolic blood pressure (mm of Hg),</li>
<li class='fragment fade-in'> Smoke: 1=smoker or 0=non-smoker,
<li class='fragment fade-in'> Overwt: 1=normal, 2=overweight or 3=obese.</li>
<br>
...
We ask ourselves if the systolic pressure is signifacntly different between smokers and non-smokers and among weight classes. 
<br>
<p class='fragment fade-in'>
...
smo <- c("Non Smoker","Smoker")

Percentage_high_pressure <- c(per_high_nsmo,per_high_smo)
Percentage_normal <- c(1-c(per_high_nsmo,per_high_smo))
per_weight <- data.frame(smo, Percentage_high_pressure)

fig4 <- plot_ly(per_weight, x = ~smo, y = ~Percentage_high_pressure, type = 'bar', name = 'SF Zoo')
fig4 <- fig4 %>% add_trace(y = ~Percentage_normal, name = 'LA Zoo')
...
fig3 <- plot_ly(per_weight, x = ~Weights, y = ~Percentage_high_pressure, type = 'bar', name = 'SF Zoo')
fig3 <- fig3 %>% add_trace(y = ~Percentage_normal, name = 'LA Zoo')
